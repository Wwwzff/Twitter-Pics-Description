...
def writeMongoDB(twitterID,imgNumber,descriptor):
    conn = pymongo.MongoClient('127.0.0.1',27017)
    db = conn.MiniProject3
    my_set = db.twitterAPI
    my_set.insert({"Login Date":asctime(localtime(time())),"twitter ID":twitterID,"Pictures":imgNumber,"Descriptor":descriptor})
...
writeMongoDB(twitterID,imgNumber,descriptor)
